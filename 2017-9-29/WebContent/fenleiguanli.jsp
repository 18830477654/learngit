...
<body>
	...
	<form action="ReadCateServlet"  method="post">
				<div >
				<button><a href="addcate.jsp" style="text-decoration: none;color: black;">添加分类</a> </button>
				</div>
					<div id="shuru" style="margin-top: 10px">
						<input type="text" placeholder="耳钉" ><input type="submit" value="搜索"/>
							...
							<tr>
								<td style="border-bottom: 44px;border-color: aqua;">编号</td>
								<td style="border-bottom: 44px;border-color: aqua;">类型名</td>
								<td style="border-bottom: 44px;border-color: aqua;">父类id</td>
								<td style="border-bottom: 44px;border-color: aqua;">操作</td>
							</tr>
